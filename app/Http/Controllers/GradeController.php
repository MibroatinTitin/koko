...
class GradeController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            $grade->delete();
            return response()->json(['success' => true, 'message' => 'Berhasil Menghapus Data Nilai']);
        } catch (\Exception $e) {
            return response()->json(['success' => false, 'message' => 'Terjadi Kesalahan Saat Menghapus Data Nilai']);
        }
    }
