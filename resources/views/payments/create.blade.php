        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('student_name').addEventListener('change', function() {
                ...
                if (selectedStudent) {
                    ...
                    document.getElementById('class').value = selectedStudent.class ? selectedStudent.class
                        .name : 'No Class';
                }
            });
            ...
            if (defaultStudent) {
                ...
                document.getElementById('class').value = defaultStudent.class ? defaultStudent.class.name :
                    'No Class';
            }
        });
    </script>
